    ...
    <div className="relative flex w-full flex-col py-8 md:flex-row">
      ...
      >
        <TabsList
          ...
          className="children:rounded-lg children:px-2 children:py-5 children:text-emerald-800 children:transition-colors z-10 -mr-8 mt-12 flex shrink-0 flex-col self-start rounded-2xl border border-surface-100/30 bg-surface-100/40 p-2 shadow-xl backdrop-blur-2xl"
        >
          <TabsTrigger
            value="tab1"
