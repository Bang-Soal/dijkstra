...
export const tabsTriggerStyle =
  "inline-flex items-center justify-center text-gray-300 whitespace-nowrap text-xl lg:text-3xl font-medium transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 data-[state=active]:text-black";
